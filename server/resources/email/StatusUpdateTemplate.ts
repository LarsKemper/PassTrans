                                    ...
                                    >
                                      <span
                                        style="
                                          ...
                                          font-family: Lato, sans-serif;
                                        "
                                        >Transfer status was changed: ${status}
                                      </span>
                                    </p>
                                  </div>
                                </td>
                                    ...
                                    <p style="font-size: 14px; line-height: 140%">
                                      <span
                                        style="
                                          ...
                                          color: #666666;
                                        "
                                        >We are sending you this message to let you know that the status of your transfer has changed. The status is currently as follows: <strong>${status}</strong></span
                                      >
                                    </p>
                                    <p style="font-size: 14px; line-height: 140%">
                                      &nbsp;
                                    ...
                                    <p style="font-size: 14px; line-height: 140%">
                                      <span
                                        style="
                                          ...
                                          color: #666666;
                                        "
                                        >To access your transfer follow the link below:
                                      </span>
                                    </p>
                                  </div>
                                </td>
