export const CreatedTemplate = (accessId: string): string => {
  return `
                                    ...
                                    <p style="font-size: 14px; line-height: 140%">
                                      <span
                                        style="
                                          ...
                                          color: #666666;
                                        "
                                        >We are sending you this email to let you know that your transfer has now been activated and can be accessed from now on.</span
                                      >
                                    </p>
                                    <p style="font-size: 14px; line-height: 140%">
                                      &nbsp;
